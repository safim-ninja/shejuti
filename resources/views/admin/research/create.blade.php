        ...
        <div class="flex items-center space-x-4">
            <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex">
                    ...
                    <li class="flex items-center">
                        <h2 class="text-2xl font-bold text-emerald-700">New Research</h2>
                    </li>
                </ol>
            </nav>
        </div>
...
{{-- title,published date,description,Topic,link --}}
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow p-8">
        <h2 class="mb-6 text-2xl font-bold text-emerald-600 text-center">Create New Research</h2>
        <form action="/admin/research" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            <div>
