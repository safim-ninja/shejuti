...
@section('content')
        ...
        <div class="flex items-center space-x-4">
            <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex">
                    ...
                    <li class="flex items-center">
                        <h2 class="text-2xl font-bold text-emerald-700">Edit Project</h2>
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow p-8">
        <h2 class="mb-6 text-2xl font-bold text-emerald-600 text-center">Edit Project</h2>
        <form action="/admin/projects/{{ $project->id }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            @method('PATCH')
            <div>
            ...
            <div>
                ...
                <input type="url" name="video_link" id="video_link" value="{{ old('video_link', $project->video_link) }}"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm"
