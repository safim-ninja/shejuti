            ...
            <div id="smooth-content">
                ...
                <main>
                    ...
                    <section class="banner-two">
                                ...
                                <div class="col-12">
                                    <div class="banner-two-inner">
                                        <div class="banner-two__meta">
                                            <div class="thumb">
                                                <img src="{{ asset('assets/images/1672715021102.jpeg') }}"
                        ...
                        <img src="{{ asset('assets/images/banner/dawn-light.png') }}" alt="Image" class="dawn">
                    </section>
                    <!-- ==== / banner end ==== -->
                    <!-- ==== sponsor start ==== -->
                                ...
                                <div class="col-12">
                                    <div class="sponsor__slider ">
                                        <div class="sponsor__slider-item">
                                            <img src="{{ asset('assets/images/sponsor/one-dark.png') }}" alt="Image">
                                        </div>
                                        <div class="sponsor__slider-item">
                                            <img src="{{ asset('assets/images/sponsor/two-dark.png') }}" alt="Image">
                                        </div>
                                        <div class="sponsor__slider-item">
                                            <img src="{{ asset('assets/images/sponsor/three-dark.png') }}" alt="Image">
                                        </div>
                                        <div class="sponsor__slider-item">
                                            <img src="{{ asset('assets/images/sponsor/four-dark.png') }}" alt="Image">
                                        </div>
                                        <div class="sponsor__slider-item">
                                            <img src="{{ asset('assets/images/sponsor/five-dark.png') }}" alt="Image">
                                        </div>
                                        <div class="sponsor__slider-item">
                                            <img src="{{ asset('assets/images/sponsor/six-dark.png') }}" alt="Image">
                                        </div>
                                        <div class="sponsor__slider-item">
                                            <img src="{{ asset('assets/images/sponsor/one-dark.png') }}" alt="Image">
                                        </div>
                    ...
                    <section class="section award">
                            ...
                            <div class="row gaper align-items-center">
                                <div class="col-12 col-lg-6">
                                    <div class="award__thumb dir-rtl">
                                        <img src="{{ asset('assets/images/award-thumb.png') }}" alt="Image"
                        ...
                        <img src="{{ asset('assets/images/star.png') }}" alt="Image" class="star-two">
                        <img src="{{ asset('assets/images/agency/dot-large.png') }}" alt="Image" class="dot">
                        <img src="{{ asset('assets/images/agency/dot-large.png') }}" alt="Image" class="dot-two">
                    </section>
                    <!-- ==== / award end ==== -->
                    <!-- ==== offer start ==== -->
                            ...
                            <div class="offer-two__slider-single offer__cta">
                                <div class="offer__cta-single">
                                    ...
                                    <div class="offer-thumb-hover d-none d-md-block"
                                        data-background="{{ asset('assets/images/ball.png') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="offer-two__slider-single offer__cta">
